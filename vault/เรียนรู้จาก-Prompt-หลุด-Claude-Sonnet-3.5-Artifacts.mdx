...
### **ใช้งานโมเดลตามที่ถูกฝึกมา**
เริ่มมาเราจะสังเกตุเห็นว่า เขามีการใช้ `</>` เต็มไปหมด และนี้เองเป็นเทคนิคแรก การใช้งานโมเดลตามที่ถูกฝึกมา ถ้าเอาให้แน่ใจ เราควรไปเช็คกับ model card หรืองานวิจัยที่ตีพิมพ์ของโมเดลนั้นๆ เช่น [Claude 3.5 Sonnet Model Card](https://www-cdn.anthropic.com/fed9cc193a14b84131812372d8d5857f8f304c52/Model_Card_Claude_3_Addendum.pdf) เพื่อเช็คว่า มีคำศัพท์พิเศษใดบ้างที่โมเดลจับทางได้ดีเป็นพิเศษ หากใครไม่มีเวลาเช็ค ก็ไม่ต้องเป็นกังวลไป เพราะโมเดลส่วนมากนั้นคล้ายกันในส่วนนี้ คือใช้ xml tags การใช้คำศัพท์พิเศษเหล่านี้จะช่วยบ่งบอกให้โมเดลรับรู้ว่า นี้เป็นส่วนเดียวกัน เช่นอันนี้คือตัวอย่างนะ อันนี้คือคำบรรยายนะ อันนี้คือคำสั่งนะ
...
ใน Prompt ตัวอย่าง มีคำสั่งให้เขียน artifacts ดังนั้นเขาก็จะระบุให้ชัดเจนว่า artifacts ที่ดีควรเป็นอย่างไร ที่ไม่ดีเป็นอย่างคนอื่นที่ไม่ทำงานเกี่ยวข้องโดยตรงลองอ่านดูว่า ถ้าให้ทำตามคำสั่งเหล่านี้ ด้วยคำอธิบายทั้งหมดนี้ เพียงพอสำหรับการเริ่มทำงานไหม

เทียบเคียงในตัวอย่าง คือส่วน <Code language='xml'>&lt;/artifacts_info></Code>

### Chain of Though
ต่อมา Chain of thought หรือการให้น้องเอไอคิดออกมา ก่อนสรุปคำตอบสุดท้าย ในตัวอย่างเขาจะให้เอไอคิดออกมา โดยทดไว้ในกรอบ <Code language='xml'>&lt;/antThinking></Code> ในขั้นตอนแรก แล้วจึงค่อยคิดคำตอบสุดท้าย เทคนิคนี้ช่วยได้อย่างมากถ้าคำถามของเราเกี่ยวข้องกับการคิดเป็นลำดับขั้นตอน ซึ่งปกติแล้วขั้นตอนนี้ เราจะไม่เห็นกันว่าถูกใช้ เพราะจะเป็นจังหวะที่ทำงานอยู่เบื้องหลัง และก่อนที่จะส่งผลลัพธ์สุดท้ายมาให้เราดู

### Few-Shot Prompting
สุดท้ายเทคนิค Few Shot Prompting หรือการให้ตัวอย่างของคำถาม และคำตอบหลายๆอัน ในตัวอย่าง เขาจะระบุอยู่ใน <Code language='xml'>&lt;/examples></Code> แล้วในนั้นก็จะประกอบด้วย <Code language='xml'>&lt;/example_docstring></Code> ที่อธิบายตัวอย่าง แล้วถึงตามมาด้วย <Code language='xml'>&lt;/example></Code> ซึ่งประกอบไปด้วย <Code language='xml'>&lt;/user_query></Code> ระบุคำถามจากผู้ใช้ และ <Code language='xml'>&lt;/assistant_response></Code> ระบุคำตามจากเอไอ
