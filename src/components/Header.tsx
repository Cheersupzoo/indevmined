...
export const Header = ({ en, th }: Props) => {
  return (
    <header className='relative left-0 right-0 top-0 z-50 mx-auto h-24 w-full max-w-2xl bg-transparent pt-6 '>
      <div className='flex items-center py-3 justify-between'>
        <Link href='/post' className='text-eva-text font-bold text-2xl'>
          InDevMined
        </Link>
        <div>
          {en && (
